...
*/
    ...
    while(!done){
        ...
        if ((checkRobotReachedEnd(&robot, OVERALL_WINDOW_WIDTH, OVERALL_WINDOW_HEIGHT/2+100, 10, 100) // Default maze
             //checkRobotReachedEnd(&robot, 640, 340, 10, 100) // Simple 1
             //checkRobotReachedEnd(&robot, 220, 480, 100, 10) // Simple 2
             //checkRobotReachedEnd(&robot, 0, 340, 10, 100) // Simple 3
             //checkRobotReachedEnd(&robot, 640-10-320, 480, 100, 10) // Simple 4
             //checkRobotReachedEnd(&robot, 640, 20, 10, 60) // Complex 5
             //checkRobotReachedEnd(&robot, 120, 480, 100, 10) // Complex 6
             //checkRobotReachedEnd(&robot, 0, 20, 10, 60) // Complex 7
             //checkRobotReachedEnd(&robot, 640-10-220, 480, 100, 10) // Complex 8
             )){
            end_time = clock();
